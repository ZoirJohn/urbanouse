...
export default function Filter() {
        ...
        return (
                <div className='flex gap-5 justify-center py-15 col-span-3 max-md:justify-start max-lg:col-span-2 max-xs:pt-5 max-md:col-span-1 overflow-auto'>
                        <Button className='rounded-3xl text-base h-10' variant={filter == 'all' ? 'default' : 'outline'} onClick={() => setFilter('all')}>
                                All Properties
                        </Button>
                        <Button className='rounded-3xl text-base h-10' variant={filter == 'family' ? 'default' : 'outline'} onClick={() => setFilter('family')}>
                                Family House
                        </Button>
