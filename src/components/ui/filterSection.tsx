...
export default function FilterSection() {
        ...
        const [path, buildPath] = useState<string>('/properties')
        ...
        return (
                <section className='pb-10 pt-25 max-md:pt-15 max-md:pb-5'>
                        <div className='container flex flex-col items-center gap-15'>
                                ...
                                <form
                                        action=''
                                        className='flex flex-wrap items-center justify-center gap-20 max-lg:gap-7 max-xs:flex-col max-xs:text-center max-xs:w-full max-xs:px-4'
